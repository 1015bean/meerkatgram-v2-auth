...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain filterChain(HttpSecurity httpSecurity, HeaderAuthenticationFilter headerAuthenticationFilter) throws Exception {
        return httpSecurity
                ...
                .addFilterBefore(headerAuthenticationFilter, UsernamePasswordAuthenticationFilter.class)  // 커스텀 필터 추가(커스텀 필터 이름, 커스텀 필터에 대한 정보(커스텀 필터에서 사용해야 하므로 미리 생성, 이 객체 생성하고 커스텀 필터 실행))
